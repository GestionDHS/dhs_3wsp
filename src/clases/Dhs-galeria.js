...
import spinner from "../img/cargando.png"
...
export class DHS_Gallery {
  ...
  imageLib = {
    ...
    spinner:{
      ...
      url:spinner,
      nombre:"spinner",
      parrafoLicencia:"<a href='https://www.flaticon.es/iconos-gratis/cargando' title='cargando iconos'>Cargando iconos creados por Freepik - Flaticon</a>",
      showLicense:true,
    },
  };
}
